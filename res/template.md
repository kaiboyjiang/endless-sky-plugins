...
%plugin template below this line%

---

### %name%

![Download count](https://img.shields.io/github/downloads/kaiboyjiang/endless-sky-plugins/%name%.zip?displayAssetName=false&style=for-the-badge&label=Downloads&color=rgb(30,90,50)) ![%size%](https://img.shields.io/badge/%convertedsize%-rgb(20,130,60)?style=for-the-badge) ![%lastmodified%](https://img.shields.io/badge/%fancylastmodified%-rgb(10,170,80)?style=for-the-badge)

%icon%

[![Download](https://img.shields.io/badge/Download_v%version%-rgb(20,40,90)?style=for-the-badge)](%assetfullpath%%assetfile%) [![Versions](https://img.shields.io/badge/Versions-rgb(65,90,130)?style=for-the-badge)](https://github.com/kaiboyjiang/endless-sky-plugins/releases?q=%name%&expanded=true) [![Data](https://img.shields.io/badge/Data-rgb(120,140,170)?style=for-the-badge)](%pluginurl%%pluginnameurl%/) %imagemd%<br>
<br>
%description%
<details>
